...
- **子供でも楽しいキャンディポップな配色**：夜空にピンク・シアン・ゴールドの3色が輝くガムボールマシンのような背景グロー＋きらめく星空。パワーアップボタンはピンク／オレンジ／シアンの3色に分かれたガムボール風トリオ、Nextボタンは鮮やかなライムグリーン——単調な一色にせず、あえて色を散らして楽しい配色に。UI は英語・アイコン中心。
