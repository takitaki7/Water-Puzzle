...
- クリアで**コイン**を獲得（基本 40 ＋ スター数 × 30）。貯めたコインでパワーアップを購入できます。残数・コインは `localStorage` に保存されます。
...
- **完成/クリア演出**：ボトルが単色で満タンになると、放射フラッシュ＋二重の衝撃リング＋弾け飛ぶスパークル＋コルクが弾んで閉まるバウンドで祝福。クリア時は全ボトルが連鎖ポップ→紙吹雪＋**スター評価（最短手数と比較して★1〜3）**＋獲得コイン表示。
